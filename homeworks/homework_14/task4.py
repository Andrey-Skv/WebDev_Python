...
test_employee_str: Тестирование метода __str__(). Создайте объект Employee с данными: фамилия "Ivanov", имя 
"Ivan", отчество "Ivanovich", возраст 30, должность "manager" и зарплата 50000. Убедитесь, что метод 
...
class TestEmployee(unittest.TestCase):
    def test_employee_full_name(self):
        ...
        self.assertEqual(employee.full_name(), 'Ivanov Ivan Ivanovich')
        
    def test_employee_birthday(self):
        employee = Employee('Ivanov', 'Ivan', 'Ivanovich', 30,'manager', 50000)
        employee.birthday()
        self.assertEqual(employee.get_age(), 31)
    ...
    def test_employee_str(self):
        employee = Employee('Ivanov', 'Ivan', 'Ivanovich', 30,'manager', 50000)
        self.assertEqual(str(employee), 'Ivanov Ivan Ivanovich (Manager)')

    def test_employee_last_name_title(self):
        employee = Employee('Ivanov', 'Ivan', 'Ivanovich', 30,'manager', 50000)
        self.assertEqual(employee.last_name, 'Ivanov')
