...
ферзей на шахматной доске, в которой ни один ферзь не бьет другого. Другими словами, ферзи размещены таким
...
def generate_boards():
    ...
    while len(board_list) < 4:
        queens = [(i, random.randint(1, 8)) for i in range(1, 9)] # генерация случайных координат ферзей
        if check_queens(queens): # проверка на успешную расстановку
